...
const std::array<const IUS4V6Adapter *, 8> &AdapterTable() {
  ...
  static const std::array<const IUS4V6Adapter *, 8> kAdapters = {
      &kQwenAdapter,  &kGemmaAdapter,    &kBitNetAdapter, &kTernaryAdapter,
      &kLlamaAdapter, &kDeepSeekAdapter, &kKimiAdapter,   &kMiniMaxAdapter};
  return kAdapters;
}
